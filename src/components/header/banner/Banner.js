...
const Banner = () => {
    return (
        <section className='my-14 grid grid-cols-2 container mx-auto items-center gap-10'>
            ...
            <div>
                <p className='text-slate-800 text-center capitalize'><strong>quiz help grow our active knowledge. <br /> help to more learning. <br /> soft skill growing. <br /> feel more confident to discuss the material.</strong></p>
            </div>
        </section>
    );
};
